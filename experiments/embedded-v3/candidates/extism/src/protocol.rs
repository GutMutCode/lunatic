// @generated by tools/candidate-wire-frozen-check.mjs; do not hand-edit.
//
...
pub struct HelloControl {
    ...
    pub expected_candidate: CandidateKind,
}
...
fn decode_bounded<T: serde::de::DeserializeOwned>(line: &str) -> Result<T, serde_json::Error> {
...
pub fn decode_control_line(line: &str) -> Result<ControlEnvelope, serde_json::Error> {
    let envelope = decode_bounded(line)?;
...
mod frozen_wire_tests {
    ...
    fn canonical_decimal_and_closed_structs_are_strict() {
        let numeric_id = r#"{"schema_version":3,"request_id":1,"message":{"shutdown":{}}}"#;
        let leading_zero = r#"{"schema_version":3,"request_id":"1","message":{"teardown_tenant":{"tenant_id":0,"incarnation":"01"}}}"#;
        let unknown =
