...
| Global registration coordinates across nodes | Four real mTLS QUIC tests covering 2/3/5-node contention, request-ID uniqueness, quorum and resync | Cluster-wide resource quotas and crash chaos are not covered |
